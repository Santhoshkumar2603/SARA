...
firebase.auth().onAuthStateChanged((user) => {
  if (user) {
    ...
    var first = snap.child("/21/1").val();
    var second = snap.child("/22/2").val();
...
let labels2 = ['Sitting Posture','Self Assessment', 'Hand-Eye Coordination'];
...
$(document).ready(function(){
    ...
    <div class="d-flex w-100 justify-content-between">
      <h5><b>${element.question2}</b></h5>
    </div>
    <br>
    <p style="color:#0a2166" class="mb-1"> ${element.answer2}</p>
    </div>`;
      }
